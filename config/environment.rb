...
Rails::Initializer.run do |config|
  ...
  config.gem 'ruby-hmac', :version => '0.3.2'
  ...
  config.action_controller.session = {
    :session_key => '_twitter2rss_session',
    :secret      => 'b615d4216e97eb47917107593310f7648a5182bb098ccb778b455c56e17b08911f3a0274b61df070c57f6bbfb487638db2e2593be3a7239c70fefe63c4cf6fea'
  }
